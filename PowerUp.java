...
public class PowerUp extends Sprite {
    ...
    public PowerUp(int xpos, int ypos, int type) {
        ...
        if (type == 1) {
            ...
            loadSprite("Images/minigun.png"); // 7 seconds auto minigun - decreases reload time by 3x. <<< Not yet implemented
        } else if (type == 5) {
            loadSprite("Images/sniper.png"); // 3 Ammo - Increases bullet speed by 3x. <<< Not yet implemented
        } else if (type == 6) {
